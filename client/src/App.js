    ...
    navigator.mediaDevices
      ...
      .then((stream) => {
        ...
        socketRef.current.on('user joined', (payload) => {
          const res = peersRef.current.find(
          ...
          if (res === undefined) {
            ...
            console.log('renegotiating with:', payload.callerID);
          }
        });
        socketRef.current.on('receiving returned signal', (payload) => {
          ...
          console.log('found item -->', item.peerID, item.peer);
          if (item.peer.readable === true) {
            let res = item.peer.signal(payload.signal);
            console.log('res:', res);
          }
        });
      });
